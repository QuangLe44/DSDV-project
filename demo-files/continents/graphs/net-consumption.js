...
// Net Consumption Graph
function task2() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Africa/Africa%20-%20net%20consumption.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        var top3Countries = nestedData2.slice(0, 3);
        ...
        svg
          .append("text")
          .text("Multiple Line Graph of Electricity Net Consumption (Africa)")
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
          .attr("y", h - 750)
...
function task6() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Europe/Europe%20-%20net%20consumption.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          .append("text")
          .text("Multiple Line Graph of Electricity Net Consumption (Europe)")
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
          .attr("y", h - 750)
    ...
    function (error, data) {
      if (error) {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Consumption (Central & South America)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
...
function task10() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Middle%20East/Middle%20East%20-%20net%20consumption.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Consumption (Middle East)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
...
function task12() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/North%20America/North%20America%20-%20net%20consumption.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Consumption (North America)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
