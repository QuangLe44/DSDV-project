...
function task1() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Africa/Africa%20-%20net%20generation.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          ...
          .data(
            nestedData1.filter(
              (d) => !top5Countries.map((c) => c.key).includes(d.key)
            )
          )
          .enter()
          .append("path")
        ...
        svg
          .append("text")
          .text("Multiple Line Graph of Electricity Net Generation (Africa)")
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
          .attr("y", h - 750)
    ...
    function (error, data) {
      if (!error) {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Generation (Asia & Oceania)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
...
function task5() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Europe/Europe%20-%20net%20generation.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          .append("text")
          .text("Multiple Line Graph of Electricity Net Generation (Europe)")
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
          .attr("y", h - 750)
    ...
    function (error, data) {
      if (error) {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Generation (Central & South America)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
...
function task9() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Middle%20East/Middle%20East%20-%20net%20generation.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Generation (Middle East)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
...
function task11() {
  d3.csv(
    "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/North%20America/North%20America%20-%20net%20generation.csv",
    function (error, data) {
      if (error) {
        console.log(error);
      } else {
        ...
        svg
          .append("text")
          .text(
            "Multiple Line Graph of Electricity Net Generation (North America)"
          )
          .attr("class", "axis-label")
          .attr("text-anchor", "middle")
          .attr("x", w / 2)
