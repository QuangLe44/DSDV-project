...
function task6() {
    d3.csv(
        "https://raw.githubusercontent.com/QuangLe44/DSDV-project/main/csv/Central%20%26%20South%20America/Central%20%26%20South%20America%20-%20installed%20capacity.csv",
        function (error, data) {
            if (error) {
                console.log(error);
            } else {
                ...
                svg
                    .append("text")
                    .text("Multiple Line Graph of Installed Capacity (South America)")
                    .attr("class", "axis-label")
                    .attr("text-anchor", "middle")
                    .attr("x", w / 2)
                    .attr("y", h - 750)
